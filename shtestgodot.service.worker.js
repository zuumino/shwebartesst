...
const CACHE_NAME = "shtestgodot-cache";
const OFFLINE_URL = "shtestgodot.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["shtestgodot.html","shtestgodot.js","shtestgodot.wasm","shtestgodot.pck","shtestgodot.offline.html","shtestgodot.icon.png","shtestgodot.apple-touch-icon.png"];
